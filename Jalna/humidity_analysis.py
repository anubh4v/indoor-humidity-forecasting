...
# Read the CSV file
input_file = os.path.join(script_dir, 'Jalna Indoor Data.csv')
...
# Create a month column (used in multiple plots)
df['Month'] = df['Datetime'].dt.to_period('M')

# Find all columns ending with (RH)
rh_columns = [col for col in df.columns if col.endswith('(RH) ')]

print(f"Found {len(rh_columns)} humidity columns: {rh_columns}\n")

# ============================================================================
# Plot 1: Humidity Over Time
# ============================================================================
...
print("✓ Saved: humidity_over_time.png")
...
print("✓ Saved: monthly_humidity_boxplot.png")

# ============================================================================
# Plot 3: Hourly Average Humidity
# ============================================================================
plt.figure(figsize=(20, 5 * len(rh_columns)))
...
print("✓ Saved: hourly_average_humidity.png")
